...
*/
func (a *SMSFRegistrationFor3GPPAccessApiService) _3GppSmsfRegistration(ctx context.Context, body SmsfRegistration, ueId string) (SmsfRegistration, *http.Response, error) {
	var (
