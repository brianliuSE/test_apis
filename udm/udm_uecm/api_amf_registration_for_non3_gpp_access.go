...
*/
func (a *AMFRegistrationForNon3GPPAccessApiService) Non3GppRegistration(ctx context.Context, body AmfNon3GppAccessRegistration, ueId string) (AmfNon3GppAccessRegistration, *http.Response, error) {
	var (
