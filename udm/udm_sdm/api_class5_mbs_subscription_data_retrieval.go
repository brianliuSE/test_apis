 ...
 * @param optional nil or *Class5MBSSubscriptionDataRetrievalApiGetMbsDataOpts - Optional Parameters:
...
type Class5MBSSubscriptionDataRetrievalApiGetMbsDataOpts struct {
    SupportedFeatures optional.Interface
    IfNoneMatch optional.String
    IfModifiedSince optional.String
}

func (a *Class5MBSSubscriptionDataRetrievalApiService) GetMbsData(ctx context.Context, supi string, localVarOptionals *Class5MBSSubscriptionDataRetrievalApiGetMbsDataOpts) (MbsSubscriptionData, *http.Response, error) {
	var (
