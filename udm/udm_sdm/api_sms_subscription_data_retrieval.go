 ...
 * @param optional nil or *SMSSubscriptionDataRetrievalApiGetSmsDataOpts - Optional Parameters:
...
type SMSSubscriptionDataRetrievalApiGetSmsDataOpts struct {
...
func (a *SMSSubscriptionDataRetrievalApiService) GetSmsData(ctx context.Context, supi string, localVarOptionals *SMSSubscriptionDataRetrievalApiGetSmsDataOpts) (SmsSubscriptionData, *http.Response, error) {
	var (
