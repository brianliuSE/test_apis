 ...
 * @param optional nil or *RetrievalOfSharedDataApiGetSharedDataOpts - Optional Parameters:
     * @param "SupportedFeatures" (optional.Interface of string) -  Supported Features; this query parameter should not be used
...
type RetrievalOfSharedDataApiGetSharedDataOpts struct {
	// deprecated in spec: SupportedFeatures optional.Interface
	SupportedFeatures optional.Interface
	IfNoneMatch       optional.String
	IfModifiedSince   optional.String
}

func (a *RetrievalOfSharedDataApiService) GetSharedData(ctx context.Context, sharedDataIds []string, localVarOptionals *RetrievalOfSharedDataApiGetSharedDataOpts) ([]SharedData, *http.Response, error) {
	var (
	...
	localVarQueryParams.Add("shared-data-ids", parameterToString(sharedDataIds, ""))
	if localVarOptionals != nil && localVarOptionals.SupportedFeatures.IsSet() {
		localVarQueryParams.Add("supportedFeatures", parameterToString(localVarOptionals.SupportedFeatures.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.SupportedFeatures.IsSet() {
