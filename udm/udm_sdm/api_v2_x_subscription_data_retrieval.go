 ...
 * @param optional nil or *V2XSubscriptionDataRetrievalApiGetV2xDataOpts - Optional Parameters:
...
type V2XSubscriptionDataRetrievalApiGetV2xDataOpts struct {
    SupportedFeatures optional.Interface
    IfNoneMatch optional.String
    IfModifiedSince optional.String
}

func (a *V2XSubscriptionDataRetrievalApiService) GetV2xData(ctx context.Context, supi string, localVarOptionals *V2XSubscriptionDataRetrievalApiGetV2xDataOpts) (V2xSubscriptionData, *http.Response, error) {
	var (
