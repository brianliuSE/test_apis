 ...
 * @param optional nil or *ParameterUpdateInTheNWDAFRegistrationApiUpdateNwdafRegistrationOpts - Optional Parameters:
     * @param "SupportedFeatures" (optional.Interface of string) -  Supported Features
@return InlineResponse200
*/

type ParameterUpdateInTheNWDAFRegistrationApiUpdateNwdafRegistrationOpts struct {
    SupportedFeatures optional.Interface
}

func (a *ParameterUpdateInTheNWDAFRegistrationApiService) UpdateNwdafRegistration(ctx context.Context, body NwdafRegistrationModification, ueId string, nwdafRegistrationId string, localVarOptionals *ParameterUpdateInTheNWDAFRegistrationApiUpdateNwdafRegistrationOpts) (InlineResponse200, *http.Response, error) {
	var (
