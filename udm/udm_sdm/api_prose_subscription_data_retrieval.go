 ...
 * @param optional nil or *ProseSubscriptionDataRetrievalApiGetProseDataOpts - Optional Parameters:
...
type ProseSubscriptionDataRetrievalApiGetProseDataOpts struct {
    SupportedFeatures optional.Interface
    IfNoneMatch optional.String
    IfModifiedSince optional.String
}

func (a *ProseSubscriptionDataRetrievalApiService) GetProseData(ctx context.Context, supi string, localVarOptionals *ProseSubscriptionDataRetrievalApiGetProseDataOpts) (ProseSubscriptionData, *http.Response, error) {
	var (
