...
*/
func (a *IPSMGWRegistrationApiService) IpSmGwRegistration(ctx context.Context, body IpSmGwRegistration, ueId string) (IpSmGwRegistration, *http.Response, error) {
	var (
