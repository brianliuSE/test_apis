...
*/
func (a *NWDAFRegistrationApiService) NwdafRegistration(ctx context.Context, body NwdafRegistration, ueId string, nwdafRegistrationId string) (NwdafRegistration, *http.Response, error) {
	var (
