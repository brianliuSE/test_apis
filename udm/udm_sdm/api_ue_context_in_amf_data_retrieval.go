 ...
 * @param optional nil or *UEContextInAMFDataRetrievalApiGetUeCtxInAmfDataOpts - Optional Parameters:
     * @param "SupportedFeatures" (optional.Interface of string) -  Supported Features
@return UeContextInAmfData
*/

type UEContextInAMFDataRetrievalApiGetUeCtxInAmfDataOpts struct {
    SupportedFeatures optional.Interface
}

func (a *UEContextInAMFDataRetrievalApiService) GetUeCtxInAmfData(ctx context.Context, supi string, localVarOptionals *UEContextInAMFDataRetrievalApiGetUeCtxInAmfDataOpts) (UeContextInAmfData, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UeContextInAmfData
	)
