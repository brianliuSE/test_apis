 ...
 * @param optional nil or *EnhancedCoverageRestrictionDataRetrievalApiGetEcrDataOpts - Optional Parameters:
...
type EnhancedCoverageRestrictionDataRetrievalApiGetEcrDataOpts struct {
    SupportedFeatures optional.Interface
    IfNoneMatch optional.String
    IfModifiedSince optional.String
}

func (a *EnhancedCoverageRestrictionDataRetrievalApiService) GetEcrData(ctx context.Context, supi string, localVarOptionals *EnhancedCoverageRestrictionDataRetrievalApiGetEcrDataOpts) (EnhancedCoverageRestrictionData, *http.Response, error) {
	var (
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EnhancedCoverageRestrictionData
