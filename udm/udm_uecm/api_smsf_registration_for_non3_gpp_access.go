...
*/
func (a *SMSFRegistrationForNon3GPPAccessApiService) Non3GppSmsfRegistration(ctx context.Context, body SmsfRegistration, ueId string) (SmsfRegistration, *http.Response, error) {
	var (
