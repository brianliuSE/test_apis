 ...
 * @param optional nil or *LCSMobileOriginatedDataRetrievalApiGetLcsMoDataOpts - Optional Parameters:
...
type LCSMobileOriginatedDataRetrievalApiGetLcsMoDataOpts struct {
    SupportedFeatures optional.Interface
    IfNoneMatch optional.String
    IfModifiedSince optional.String
}

func (a *LCSMobileOriginatedDataRetrievalApiService) GetLcsMoData(ctx context.Context, supi string, localVarOptionals *LCSMobileOriginatedDataRetrievalApiGetLcsMoDataOpts) (LcsMoData, *http.Response, error) {
	var (
