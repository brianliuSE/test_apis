 ...
 * @param optional nil or *AMF3GppAccessRegistrationInfoRetrievalApiGet3GppRegistrationOpts - Optional Parameters:
     * @param "SupportedFeatures" (optional.Interface of string) - 
@return Amf3GppAccessRegistration
*/

type AMF3GppAccessRegistrationInfoRetrievalApiGet3GppRegistrationOpts struct {
    SupportedFeatures optional.Interface
}

func (a *AMF3GppAccessRegistrationInfoRetrievalApiService) Get3GppRegistration(ctx context.Context, ueId string, localVarOptionals *AMF3GppAccessRegistrationInfoRetrievalApiGet3GppRegistrationOpts) (Amf3GppAccessRegistration, *http.Response, error) {
	var (
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v Amf3GppAccessRegistration
