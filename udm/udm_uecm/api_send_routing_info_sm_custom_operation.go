...
*/
func (a *SendRoutingInfoSMCustomOperationApiService) SendRoutingInfoSm(ctx context.Context, body RoutingInfoSmRequest, ueId string) (RoutingInfoSmResponse, *http.Response, error) {
	var (
