 ...
 * @param optional nil or *SliceSelectionSubscriptionDataRetrievalApiGetNSSAIOpts - Optional Parameters:
...
type SliceSelectionSubscriptionDataRetrievalApiGetNSSAIOpts struct {
...
func (a *SliceSelectionSubscriptionDataRetrievalApiService) GetNSSAI(ctx context.Context, supi string, localVarOptionals *SliceSelectionSubscriptionDataRetrievalApiGetNSSAIOpts) (Nssai, *http.Response, error) {
	var (
