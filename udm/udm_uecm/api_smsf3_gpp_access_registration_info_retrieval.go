 ...
 * @param optional nil or *SMSF3GPPAccessRegistrationInfoRetrievalApiGet3GppSmsfRegistrationOpts - Optional Parameters:
     * @param "SupportedFeatures" (optional.Interface of string) - 
@return SmsfRegistration
*/

type SMSF3GPPAccessRegistrationInfoRetrievalApiGet3GppSmsfRegistrationOpts struct {
    SupportedFeatures optional.Interface
}

func (a *SMSF3GPPAccessRegistrationInfoRetrievalApiService) Get3GppSmsfRegistration(ctx context.Context, ueId string, localVarOptionals *SMSF3GPPAccessRegistrationInfoRetrievalApiGet3GppSmsfRegistrationOpts) (SmsfRegistration, *http.Response, error) {
	var (
