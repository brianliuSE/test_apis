 ...
 * @param optional nil or *SMFSelectionSubscriptionDataRetrievalApiGetSmfSelDataOpts - Optional Parameters:
     * @param "SupportedFeatures" (optional.Interface of string) -  Supported Features
     * @param "PlmnId" (optional.Interface of PlmnId) -  serving PLMN ID
...
type SMFSelectionSubscriptionDataRetrievalApiGetSmfSelDataOpts struct {
...
func (a *SMFSelectionSubscriptionDataRetrievalApiService) GetSmfSelData(ctx context.Context, supi string, localVarOptionals *SMFSelectionSubscriptionDataRetrievalApiGetSmfSelDataOpts) (SmfSelectionSubscriptionData, *http.Response, error) {
	var (
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SmfSelectionSubscriptionData
