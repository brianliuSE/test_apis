...
*/
func (a *AMFRegistrationFor3GPPAccessApiService) _3GppRegistration(ctx context.Context, body Amf3GppAccessRegistration, ueId string) (Amf3GppAccessRegistration, *http.Response, error) {
	var (
