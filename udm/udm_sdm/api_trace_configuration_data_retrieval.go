 ...
 * @param optional nil or *TraceConfigurationDataRetrievalApiGetTraceConfigDataOpts - Optional Parameters:
...
type TraceConfigurationDataRetrievalApiGetTraceConfigDataOpts struct {
...
func (a *TraceConfigurationDataRetrievalApiService) GetTraceConfigData(ctx context.Context, supi string, localVarOptionals *TraceConfigurationDataRetrievalApiGetTraceConfigDataOpts) (TraceDataResponse, *http.Response, error) {
	var (
