...
*/
func (a *RetrieveSMFRegistrationApiService) RetrieveSmfRegistration(ctx context.Context, ueId string, pduSessionId int32) (SmfRegistration, *http.Response, error) {
	var (
