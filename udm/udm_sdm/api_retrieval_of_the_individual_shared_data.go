 ...
 * @param optional nil or *RetrievalOfTheIndividualSharedDataApiGetIndividualSharedDataOpts - Optional Parameters:
...
type RetrievalOfTheIndividualSharedDataApiGetIndividualSharedDataOpts struct {
    SupportedFeatures optional.Interface
    IfNoneMatch optional.String
    IfModifiedSince optional.String
}

func (a *RetrievalOfTheIndividualSharedDataApiService) GetIndividualSharedData(ctx context.Context, sharedDataId []string, localVarOptionals *RetrievalOfTheIndividualSharedDataApiGetIndividualSharedDataOpts) (SharedData, *http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"sharedDataId"+"}", fmt.Sprintf("%v", sharedDataId), -1)
