 ...
 * @param optional nil or *LCSBroadcastAssistanceDataTypesRetrievalApiGetLcsBcaDataOpts - Optional Parameters:
...
type LCSBroadcastAssistanceDataTypesRetrievalApiGetLcsBcaDataOpts struct {
...
func (a *LCSBroadcastAssistanceDataTypesRetrievalApiService) GetLcsBcaData(ctx context.Context, supi string, localVarOptionals *LCSBroadcastAssistanceDataTypesRetrievalApiGetLcsBcaDataOpts) (LcsBroadcastAssistanceTypesData, *http.Response, error) {
	var (
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LcsBroadcastAssistanceTypesData
