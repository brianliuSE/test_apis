 ...
 * @param optional nil or *SMSManagementSubscriptionDataRetrievalApiGetSmsMngtDataOpts - Optional Parameters:
...
type SMSManagementSubscriptionDataRetrievalApiGetSmsMngtDataOpts struct {
...
func (a *SMSManagementSubscriptionDataRetrievalApiService) GetSmsMngtData(ctx context.Context, supi string, localVarOptionals *SMSManagementSubscriptionDataRetrievalApiGetSmsMngtDataOpts) (SmsManagementSubscriptionData, *http.Response, error) {
	var (
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SmsManagementSubscriptionData
