 ...
 * @param optional nil or *UEContextInSMFDataRetrievalApiGetUeCtxInSmfDataOpts - Optional Parameters:
     * @param "SupportedFeatures" (optional.Interface of string) -  Supported Features
@return UeContextInSmfData
*/

type UEContextInSMFDataRetrievalApiGetUeCtxInSmfDataOpts struct {
    SupportedFeatures optional.Interface
}

func (a *UEContextInSMFDataRetrievalApiService) GetUeCtxInSmfData(ctx context.Context, supi string, localVarOptionals *UEContextInSMFDataRetrievalApiGetUeCtxInSmfDataOpts) (UeContextInSmfData, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UeContextInSmfData
	)
