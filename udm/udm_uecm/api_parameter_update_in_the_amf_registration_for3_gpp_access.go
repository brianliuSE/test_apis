 ...
 * @param optional nil or *ParameterUpdateInTheAMFRegistrationFor3GPPAccessApiUpdate3GppRegistrationOpts - Optional Parameters:
     * @param "SupportedFeatures" (optional.Interface of string) -  Features required to be supported by the target NF
@return PatchResult
*/

type ParameterUpdateInTheAMFRegistrationFor3GPPAccessApiUpdate3GppRegistrationOpts struct {
    SupportedFeatures optional.Interface
}

func (a *ParameterUpdateInTheAMFRegistrationFor3GPPAccessApiService) Update3GppRegistration(ctx context.Context, body Amf3GppAccessRegistrationModification, ueId string, localVarOptionals *ParameterUpdateInTheAMFRegistrationFor3GPPAccessApiUpdate3GppRegistrationOpts) (PatchResult, *http.Response, error) {
	var (
